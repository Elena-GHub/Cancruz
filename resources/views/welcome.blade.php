		...
		<nav class="navbar navbar-default w3l aits wow bounceInUp agileits w3layouts">
			<div class="container">
				...
				<div class="navbar-header agileits w3layouts">
					...
					<a class="navbar-brand agileits w3layouts" href="{{ url('/') }}">Masia Kan Cruz</a>
				</div>
	...
	<div class="projects agileits w3layouts">
		<div class="container">
			...
			<div class="col-md-4 col-sm-4 projects-grid agileits w3layouts projects-grid2 wow slideInRight">
				...
				<a class="agileits w3layoutswow slideInLeft" href="gallery.blade.php">Read More <span class="glyphicon agileits w3layouts glyphicon-arrow-right" aria-hidden="true"></span></a>
			</div>
